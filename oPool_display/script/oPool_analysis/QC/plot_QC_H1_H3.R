...
new_group_samples <- c('31.a.55','AG11-2F01', '042-100809-2F04')
...
column_x1 <- 'Full_HA_H1_stem_avg_enrich'
column_y1 <- 'Full_HA_H3_stem_avg_enrich'
outfile <- 'graph/oPool_analysis/QC/full_HA/H1_vs_H3.png'
