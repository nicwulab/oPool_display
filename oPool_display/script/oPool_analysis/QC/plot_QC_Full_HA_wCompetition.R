...
textsize <- 7
  ...
  # Save the plot
  ggsave(graphname, p, height = 1.8, width = 1.8, dpi = 300)
...
plot_params <- list(
  list(
    ...
    x_col = 'CR9114_compitition_SI06_H1_Rep1_enrich',
    y_col = 'CR9114_compitition_SI06_H1_Rep2_enrich',
    graphname = 'graph/oPool_analysis/QC/competition/CR9114_competition_SI06_H1_screen_correlation.png',
  ...
  list(
    infile = 'oPool_result/enrichment/table_s3_3.tsv',
    x_col = 'CR9114_compitition_MI15_H1_Rep1_enrich',
    y_col = 'CR9114_compitition_MI15_H1_Rep2_enrich',
    graphname = 'graph/oPool_analysis/QC/competition/CR9114_competition_MI15_H1_screen_correlation.png',
  ...
  list(
    infile = 'oPool_result/enrichment/table_s3_3.tsv',
    x_col = 'CR9114_compitition_QH_H5_Rep1_enrich',
    y_col = 'CR9114_compitition_QH_H5_Rep2_enrich',
    graphname = 'graph/oPool_analysis/QC/competition/CR9114_competition_QH_H5_screen_correlation.png',
    breaks = 10^seq(-1, 2, by = 1),
    labels = c(-1, 0, 1, 2),
    limits = c(0.05, 100)
  ),
  list(
    infile = 'oPool_result/enrichment/table_s3_3.tsv',
    x_col = 'CR9114_compitition_SH_H7_Rep1_enrich',
    y_col = 'CR9114_compitition_SH_H7_Rep2_enrich',
    graphname = 'graph/oPool_analysis/QC/competition/CR9114_competition_SH_H7_screen_correlation.png',
    breaks = 10^seq(-1, 2, by = 1),
    labels = c(-1, 0, 1, 2),
    limits = c(0.05, 100)
    ),
  list(
    infile = 'oPool_result/enrichment/table_s3_3.tsv',
    x_col = 'CR9114_compitition_Phu_FluB_Rep1_enrich',
    y_col = 'CR9114_compitition_Phu_FluB_Rep2_enrich',
    graphname = 'graph/oPool_analysis/QC/competition/CR9114_competition_Phu_FluB_screen_correlation.png',
  ...
  list(
    infile = 'oPool_result/enrichment/table_s3_3.tsv',
    x_col = 'CR9114_compitition_Lee_FluB_Rep1_enrich',
    y_col = 'CR9114_compitition_Lee_FluB_Rep2_enrich',
    graphname = 'graph/oPool_analysis/QC/competition/CR9114_competition_Lee_FluB_screen_correlation.png',
    breaks = 10^seq(-1, 2, by = 1),
    labels = c(-1, 0, 1, 2),
    limits = c(0.05, 150)
    )
