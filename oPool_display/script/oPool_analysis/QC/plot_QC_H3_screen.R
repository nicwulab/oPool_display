...
new_group_samples <- c('31.a.55', '042-100809-2F04')
print(new_group_samples)

# Define file and column names
infile <- 'oPool_result/enrichment/table_s3_3.tsv'
column_x1 <- 'Full_HA_H3_stem_Rep1_enrich'
column_y1 <- 'Full_HA_H3_stem_Rep2_enrich'
outfile <- 'graph/oPool_analysis/QC/full_HA/H3_screen_correlation.png'
