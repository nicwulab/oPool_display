...
df_blue <- data.frame(
  Antibody = c("31.a.55", "AG11-2F01", "16.ND.92"),
  scFv_KD_nM = c(32.1, 3.48, 1040),
  Fab_KD_nM = c(159, 30.3, 160),
  check.names = FALSE
)

# Data for the yellow table
df_yellow <- data.frame(
  Antibody = c("240-14-IgA-2F02", "56.j.01", "01.ad.01", "31.a.55", "042-100809-2F04", "01.h.02"),
  scFv_KD_nM = c(37.2, 32.4, 3.6, 41.2, 131, 5.14),
  Fab_KD_nM = c(37.7, 8.8, 1, 260, 12.4, 1),
  check.names = FALSE
)

# Color gradient to be used for both heatmaps
H1_colors <- c( "#5A7F32", "#A2C96D", "#E8F2DB", "white")
H3_colors <- c("#ff7400","orange","#ffd700", "white")

# Create heatmaps with adjustable dimensions
create_heatmap(df_blue, H1_colors, "graph/validation/BLI/H1_validation_heatmap.png", width = 2, height = 2)
create_heatmap(df_yellow,H1_colors, "graph/validation/BLI/H3_validation_heatmap.png", width = 2.7, height = 2)