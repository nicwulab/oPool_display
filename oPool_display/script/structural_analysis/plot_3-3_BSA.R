...
input_file <- "experimental_data/structural_analysis/3-3_BSA_percentage.tsv"
...
create_bar_chart(data, cdr_h3_color, "graph/structural_analysis/BSA_IGHD3-3_bar_plot.png", 3, 1.4)