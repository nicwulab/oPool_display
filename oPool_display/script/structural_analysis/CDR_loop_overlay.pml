...
load experimental_data/structural_analysis/PDB/SI06HA_16ND_OO_v2.pdb
create 16ND_mono, SI06HA_16ND_OO_v2 and chain A+B+J+K
hide all
show cartoon,16ND_mono

load experimental_data/structural_analysis/PDB/56.a.09_mono.cif
...
load experimental_data/structural_analysis/PDB/SI06HA2F01v6_real_space_refined.pdb
create 2F01_mono, SI06HA2F01v6_real_space_refined and chain A+B+H+L
align 2F01_mono and chain A+B,  16ND_mono and chain A+B

load experimental_data/structural_analysis/PDB/SIA28_mono.cif
align SIA28_mono and chain A+B,  16ND_mono and chain A+B

load experimental_data/structural_analysis/PDB/429_B01_mono.cif
...
load experimental_data/structural_analysis/PDB/39.29_mono.cif
align 39.29_mono and chain A,  16ND_mono and chain A+B

load experimental_data/structural_analysis/PDB/1G05_mono.cif
align 1G05_mono and chain A+B,  16ND_mono and chain A+B

load experimental_data/structural_analysis/PDB/MEDI8852_mono.cif
...
set_view (\
 ...
 ray 2000,2000
 png graph/structural_analysis/PDB/CDR_overlay.png