...
input_file <- "experimental_data/structural_analysis/bsa_percentage.tsv"
...
create_stacked_bar_chart(data, colors, "graph/structural_analysis/BSA_stacked_bar_chart.png", 3, 1.5)