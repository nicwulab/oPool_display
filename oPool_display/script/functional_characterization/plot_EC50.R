...
df_new <- data.frame(
  Antigen = c("H1/USSR77", "H1/TW86", "H1/BJ95", "H1/SI06", "H1/CA09", 
              "H1/MI15", "H1/BR18", "H5/WA14","H5/MO15","H5/FL22","H1 stem","H3 stem"),
...
df_new_long$Antigen <- factor(df_new_long$Antigen, levels = c("H1/USSR77", "H1/TW86", "H1/BJ95", "H1/SI06", "H1/CA09", 
              "H1/MI15", "H1/BR18", "H5/WA14","H5/MO15","H5/FL22","H1 stem","H3 stem"))
