...
set.seed(5)
df <- read_tsv('experimental_data/functional_characterization/invivo_weight_loss.tsv')
plot_invivo_weight_loss(filter(df, ab=='2F01'), 'graph/functional_characterization/invivo_weight_loss_2F01.png',1.8,3,'dpi',bquote(bold("% of initial weight")))
plot_invivo_weight_loss(filter(df, ab=='16ND92'), 'graph/functional_characterization/invivo_weight_loss_16ND92.png',1.8,3,'dpi',bquote(bold("% of initial weight")))

df <- read_tsv('experimental_data/functional_characterization/invivo_survival.tsv')
plot_survival(filter(df, ab=='2F01'), 'graph/functional_characterization/invivo_survival_2F01.png',1.8,2.7,'dpi',bquote(bold("survival (%)")))
plot_survival(filter(df, ab=='16ND92'), 'graph/functional_characterization/invivo_survival_16ND92.png',1.8,2.7,'dpi',bquote(bold("survival (%)")))

df <- read_tsv('experimental_data/functional_characterization/invivo_lung_titer.tsv')
plot_lung_titer(filter(df, ab=='2F01'), 'graph/functional_characterization/invitro_lung_titer_Vero_2F01.png',2.2,2.4,'',expression(bold(log['10']~TCID['50']~"/mL")))
plot_lung_titer(filter(df, ab=='16ND92'), 'graph/functional_characterization/invitro_lung_titer_Vero_16ND92.png',2.2,2.4,'',expression(bold(log['10']~TCID['50']~"/mL")))
